...
void CMapScroll::Update(){
	if ((CFade::mMapfile == CFade::EGAMEMAP_NUM::ETUTORIAL && CMapEndSign::mpEndSign != NULL && CMapEndSign::mpEndSign->mPosition.x <= mPosition.x + 608.0f) ||
		((CFade::mMapfile == CFade::EGAMEMAP_NUM::EMAIN || CFade::mMapfile == CFade::EGAMEMAP_NUM::EEDITER) && CMapBossRoomSign::mpBossRoomSign != NULL && CMapBossRoomSign::mpBossRoomSign->mPosition.x <= mPosition.x - 608.0f))
		scroll_stop = true;
